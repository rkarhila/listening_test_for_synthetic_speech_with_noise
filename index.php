...
$prefcats=array(
    "A" => "First sample is better <br><i>Ensimm‰inen n‰yte on parempi</i>", 
    "B" => "Second sample is better <br><i>Toinen n‰yte on parempi</i>",
    "same" => "They sound exactly the same <br><i>N‰ytteet kuulostavat t‰ysin samalta</i>");
